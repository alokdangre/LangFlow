  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Floating particles */}
        <div className="absolute top-32 right-20 w-2 h-2 bg-green-400/30 rounded-full animate-float"></div>
        <div className="absolute top-60 left-32 w-1 h-1 bg-cyan-400/40 rounded-full animate-float delay-500"></div>
        <div className="absolute bottom-40 right-1/4 w-1.5 h-1.5 bg-purple-400/30 rounded-full animate-float delay-1000"></div>
        <div className="absolute bottom-32 left-1/4 w-2 h-2 bg-pink-400/30 rounded-full animate-float delay-1500"></div>
      </div>
      ...
      <nav className="fixed top-0 w-full bg-slate-900/80 backdrop-blur-xl border-b border-white/10 z-50">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/auth/signin" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">
              Sign In
            </Link>
          </div>
        </div>
